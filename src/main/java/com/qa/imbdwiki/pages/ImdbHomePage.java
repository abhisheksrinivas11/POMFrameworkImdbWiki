...
public class ImdbHomePage {
	...
	private By searchSuggList = By.xpath("//ul[contains(@class,'react-autosuggest__suggestions-list')]//li//a[@data-testid='search-result--const']//div[@class='sc-d2740ffb-1 duOqOv']//div[contains(@class,'searchResult__constTitle')]");
